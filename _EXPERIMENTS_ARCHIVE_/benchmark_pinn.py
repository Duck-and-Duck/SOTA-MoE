...
print("=========================================================================")
print("      GERCEKCI VE TAVIZSIZ BILANCO V18 (PINN MORFOLOJI TESTI)            ")
...
vetter = PhysicsInformedAstroNet().to(device)
vetter.load_state_dict(torch.load("astronet_pinn.pt", map_location=device))
vetter.eval()
...
def extract_advanced_physics_metrics(g_raw, l_raw):
    ...
    curvature_a = torch.sum(center_15 * W_CURV_TENSOR) * 100.0
...
def phase_fold_and_zscore(time_t, flux_t, period, t0):
    ...
    phys = extract_advanced_physics_metrics(g_norm, l_norm).view(1, 4)
...
print("\n=========================================================================")
print("               DURUST VE GERCEKCI BILIMSEL BILANCO (V18)                 ")
print("=========================================================================")
