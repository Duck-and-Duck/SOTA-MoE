...
print("="*85)
print("  OSTE-MoE SOTA DISCOVERY & CHARACTERIZATION ENGINE (ODTÜ ACADEMIC GRADE)")
...
def evaluate_candidate_discovery(time_arr, raw_flux_arr, p, t0, dur, t_gpu):
    ...
    # Z_oe için üst sınır 5.5 sigma yapılır (Leke asimetrisini tolere eder)
...
# =========================================================================
# 10 KANONİK GERÇEK NASA HEDEFİ OPERASYONU
# =========================================================================
TARGETS_10 = [
...
for tgt in TARGETS_10:
    ...
    if pred_cls == "PLANET":
        ...
        print(f"      * Denge Sıcaklığı (T_eq)   : {params['T_eq_K']:.1f} K (Albedo A_B: {params['Albedo']:.2f})")
